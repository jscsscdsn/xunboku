...
(function(w){
    w.DL={
        ...
        urlXM:function(url){
            ...
            return out.replace(/[-_]/g, function(m0) { return m0 == '-' ? '+' : '../default.htm' }).replace(/[^A-Za-z0-9\+\/]/g, '');
        },
        urlLX:function(url){
